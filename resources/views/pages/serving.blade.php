...
<body class="serving-page serving-parallax">
    ...
    <main>
        <section class="serving-hero-page-section" data-serving-hero>
            <div class="serving-curve serving-curve-hero" data-serving-parallax data-serving-speed="38"></div>
            <div class="serving-bean serving-bean-left" data-serving-parallax data-serving-speed="52"></div>
            ...
            <div class="serving-method-container container serving-method-grid">
                <div class="serving-method-content" data-serving-reveal>
                    ...
                    <ol class="serving-method-list">
                        <li><span><strong>Tuang:</strong> Buka 1 sachet KOPSOON dan tuang ke dalam cangkir favoritmu.</span></li>
                        <li><span><strong>Seduh:</strong> Tambahkan 150ml air panas, suhu ideal 85–90°C agar santan tidak pecah.</span></li>
                        <li><span><strong>Aduk &amp; Nikmati:</strong> Aduk hingga larut sempurna. Nikmati sensasi creamy dan gurih khas Nusantara!</span></li>
                    </ol>
                </div>

                <div class="serving-method-image-wrap" data-serving-parallax data-serving-speed="34" data-serving-reveal data-serving-reveal-delay="120">
        ...
        <section class="serving-method-section serving-method-ice serving-parallax-section">
            <div class="serving-method-container container serving-method-grid serving-method-grid-reverse">
                <div class="serving-method-image-wrap" data-serving-parallax data-serving-speed="-30" data-serving-reveal data-serving-reveal-delay="80">
                    <img src="{{ asset('images/serving-ice.png') }}" alt="Es KOPSOON dingin" class="serving-method-image">
                </div>

                <div class="serving-method-content serving-method-content-dark" data-serving-reveal data-serving-reveal-delay="120">
                    ...
                    <ol class="serving-method-list">
                        <li><span><strong>Tuang &amp; Larutkan:</strong> Masukkan 1 sachet KOPSOON ke dalam gelas, tambahkan sedikit air panas sekitar 50ml, lalu aduk sampai larut.</span></li>
                        <li><span><strong>Dinginkan:</strong> Tambahkan 100ml air dingin.</span></li>
                        <li><span><strong>Tambahkan Es:</strong> Masukkan es batu secukupnya. Es Kopi Santan ala kafe siap dinikmati!</span></li>
                    </ol>
                </div>
            </div>
        </section>
        ...
        <section class="serving-hacks-section serving-parallax-section">
            <div class="serving-curve serving-curve-hacks" data-serving-parallax data-serving-speed="28"></div>
            <div class="serving-bean serving-bean-hacks" data-serving-parallax data-serving-speed="44"></div>
            <div class="serving-beans-outline serving-beans-outline-right" data-serving-parallax data-serving-speed="-24"></div>
            ...
            <div class="serving-hacks-container container">
                ...
                <div class="serving-hacks-grid">
                    <article class="serving-hack-card" data-serving-reveal data-serving-parallax data-serving-speed="22">
                    ...
                    <article class="serving-hack-card" data-serving-reveal data-serving-reveal-delay="120" data-serving-parallax data-serving-speed="14">
                        <div class="serving-hack-image-box">
                    ...
                    <article class="serving-hack-card" data-serving-reveal data-serving-reveal-delay="220" data-serving-parallax data-serving-speed="24">
                        <div class="serving-hack-image-box">
