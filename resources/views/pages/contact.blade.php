...
<body class="contact-page-body">
    ...
    <main>
        <section class="contact-hero-section" aria-labelledby="contact-hero-title">
            <div class="contact-hero-curve" aria-hidden="true"></div>
            <div class="contact-hero-splash" aria-hidden="true"></div>
            <div class="contact-hero-beans" aria-hidden="true"></div>
        ...
        <section class="marketplace-section" aria-labelledby="marketplace-title">
        ...
        <section class="contact-service-section" id="contact-service" aria-labelledby="contact-service-title">
            <div class="contact-service-container container">
                <div class="contact-service-copy">
                ...
                <div class="contact-service-actions" aria-label="Daftar kontak KOPSOON">
                    <a href="https://wa.me/6289912314371?text=Halo%20Admin%20KOPSOON%2C%20saya%20ingin%20bertanya%20tentang%20produk%20dan%20pemesanan." target="_blank" class="service-action-row">
                    ...
                    <a href="https://instagram.com/KOPSOON" target="_blank" class="service-action-row">
                        <span class="service-icon" aria-hidden="true">
                    ...
                    <a href="https://tiktok.com/@KOPSOON" target="_blank" class="service-action-row">
                        <span class="service-icon" aria-hidden="true">
        ...
        <section class="operational-section" aria-labelledby="operational-title">
            <div class="operational-splash" aria-hidden="true"></div>
            <div class="operational-container container">
                <h2 id="operational-title">Informasi Operasional &amp; Basecamp</h2>
        ...
        <section class="faq-section" aria-labelledby="faq-title">
            <div class="faq-curve" aria-hidden="true"></div>
            <div class="faq-splash" aria-hidden="true"></div>
            <div class="faq-beans" aria-hidden="true"></div>
